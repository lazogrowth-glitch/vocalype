"""add_content_observation.py — V9 Phase 1 Manual Content Performance Recorder.
...
Usage:
    ...
    python vocalype-brain/scripts/add_content_observation.py \\
        ...
        --lesson "saves ratio higher than likes — good sign" \\
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="V9 Manual Content Performance Recorder — append one observation.",
    ...
    parser.add_argument("--hook",             default=None,               help="Opening line or first 3–5 seconds verbatim or summarized")
    ...
    parser.add_argument("--downloads",        default=None, type=int,     help="Downloads attributed (founder-confirmed only — not auto-inferred)")
    ...
    print(divider)
    print("Written: vocalype-brain/data/content_observations.jsonl")
