...
def main() -> None:
    ...
    if latest_runs:
        print("- python vocalype-brain/scripts/orchestrator.py ask \"Which Night Shift proposal should I approve first?\"")
    else:
        print("- python vocalype-brain/scripts/night_shift.py")
