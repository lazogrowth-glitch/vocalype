...
def _is_safe_target(target_file: str) -> bool:
    ...
    if normalized.startswith("internal/brain/"):
        normalized = normalized[len("internal/brain/") :]
...
def main() -> None:
    ...
    if not auto_apply:
        print("Auto-apply is disabled by default. Review internal/brain/outputs/improvement_proposals.md manually.")
