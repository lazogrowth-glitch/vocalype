...
impl Hotkey {
    ...
    /// # Examples
    /// ```
    /// use vocalype_shortcuts_backend::{Hotkey, Modifiers, Key};
    ///
    ...
    /// Format hotkey using portable key names (lowercase with full modifier names)
    ///
...
impl FromStr for Hotkey {
    ...
    /// # Examples
    /// ```
    /// use vocalype_shortcuts_backend::Hotkey;
    ///
