#!/usr/bin/env python3
"""Vocalype Night Robot â€” Autonomous transcription improvement agent.

Usage:
  python internal/night-robot/scripts/night_robot.py status
  python internal/night-robot/scripts/night_robot.py benchmark
  python internal/night-robot/scripts/night_robot.py plan
  python internal/night-robot/scripts/night_robot.py run --cycles 3
  python internal/night-robot/scripts/night_robot.py run --cycles 10 --max-files 3 --max-lines 150
  python internal/night-robot/scripts/night_robot.py rollback-last
"""
...
def load_config() -> dict:
    if not _CONFIG_PATH.exists():
        raise FileNotFoundError(
            ...
            "Run from the repo root: python internal/night-robot/scripts/night_robot.py ..."
        )
...
def cmd_status(args: argparse.Namespace, config: dict) -> None:
    ...
    if recent:
        last = recent[0]
        print(
            f"  Last change : Cycle {last.get('cycle')} â€” "
            f"{last.get('verdict')} â€” {str(last.get('saved_at', ''))[:10]}"
        )
    else:
    ...
    reachable = llm.ping()
    print(f"  Proxy ping  : {'OK' if reachable else 'UNREACHABLE â€” start nvidia_fallback_proxy.py'}")
    print()
...
def run_single_cycle(
    ...
    report: List[str] = [
        f"# Night Robot â€” Cycle {cycle_num}",
        f"**Date**: {datetime.now().isoformat()}",
        f"**Repo**: {_REPO_ROOT}",
    ]
    cycle_data: Dict = {"cycle": cycle_num}

    # â”€â”€ 1. Scan â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 2. Baseline â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 4. Propose â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 5. Guard check â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 6. Get diff â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    diff = plan.get("unified_diff", "").strip()
    if len(diff) < 20:
        logging.info("No usable diff in plan â€” asking LLM to produce one...")
    ...
    # â”€â”€ 7. Apply â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 8. Post-patch checks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 9. Judge â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 10. Accept or rollback â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if verdict == "ACCEPT":
        logging.info("ACCEPTED â€” committing...")
        for f in files:
        ...
        logging.info(f"{verdict} â€” rolling back {files}...")
    ...
    # â”€â”€ 11. Reflection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    logging.info("Writing lesson...")
    reflection = judge.get_reflection(cycle_data)
    report.append(f"\n## Lesson Learned\n{reflection}")
    cycle_data["lesson_raw"] = reflection

    # â”€â”€ 12. Memory â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    memory.save_lesson({
        **cycle_data,
        "hypothesis": analysis[:200],
        "files_touched": files,
...
def cmd_run(args: argparse.Namespace, config: dict) -> None:
    ...
    for i in range(1, args.cycles + 1):
        ...
        logging.info(f"Cycle {i} done â€” verdict: {result.get('verdict', '?')}")

    print(f"\n{'='*50}")
    print(f"Run complete â€” {len(results)} cycle(s)")
    print(f"{'='*50}")
    for r in results:
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Vocalype Night Robot â€” autonomous transcription improvement agent",
