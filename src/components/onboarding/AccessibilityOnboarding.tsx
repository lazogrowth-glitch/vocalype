  ...
  return (
    <div className="relative h-screen w-screen flex flex-col p-6 gap-6 items-center justify-center">
      ...
      <div className="max-w-md w-full flex flex-col items-center gap-4">
        ...
        <button
          onClick={onComplete}
          className="text-sm text-text/70 hover:text-text underline underline-offset-2 transition-colors mt-2 px-3 py-1.5 rounded-lg border border-mid-gray/30 hover:border-mid-gray/50"
        >
