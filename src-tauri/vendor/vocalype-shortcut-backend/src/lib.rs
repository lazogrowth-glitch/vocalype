...
//!
//! `vocalype-shortcut-backend` provides a simple way to register and listen for global keyboard
...
//!
//! ```no_run
//! use vocalype_shortcuts_backend::{HotkeyManager, Hotkey, Modifiers, Key};
//!
//! fn main() -> vocalype_shortcuts_backend::Result<()> {
...
//!
//! ```no_run
//! use vocalype_shortcuts_backend::KeyboardListener;
//!
...
//!     }
//! }
//! # Ok::<(), vocalype_shortcuts_backend::Error>(())
//! ```
//!
//! # Platform Notes
//!
...
//! # #[cfg(target_os = "macos")]
//! # fn main() -> vocalype_shortcuts_backend::Result<()> {
//! use vocalype_shortcuts_backend::{check_accessibility, open_accessibility_settings};
//!
