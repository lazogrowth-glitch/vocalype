...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        shortcut::change_parakeet_stateful_streaming_enabled_setting,
        ...
        shortcut::native_keyboard::start_native_keyboard_recording,
        shortcut::native_keyboard::stop_native_keyboard_recording,
        ...
        commands::export_support_package,
        ...
        commands::dictionary::sync_workspace_custom_words,
        ...
        commands::snippets::sync_workspace_voice_snippets,
