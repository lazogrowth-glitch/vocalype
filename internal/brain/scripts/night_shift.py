...
FOCUS_AREAS = [
    {
        ...
        "files_hint": ["internal/brain/", "src/", "src-tauri/"],
    },
    {
    ...
    },
    {
        ...
        "files_hint": ["internal/brain/memory/"],
    },
    {
        "name": "Test coverage",
    ...
    },
    {
        ...
        "files_hint": ["README", "docs/", "internal/brain/"],
    },
]
...
def _report_markdown(
    ...
    lines = [
        "# Vocalype Brain â€” Night Shift Report",
        "",
    ...
    for cycle in cycles:
        lines.extend(
            [
                f"### Cycle {cycle['cycle']} â€” {cycle['focus_area']}",
                "",
...
def main() -> None:
    ...
    print("Report: internal/brain/outputs/night_shift_report.md")
