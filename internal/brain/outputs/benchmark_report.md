# Vocalype Brain â€” V7 Benchmark Report
...
| Metric | Observations | Baseline ready (â‰¥5) |
|---|---|---|
| `total_dictation_latency_ms` | 9 | âœ… Yes |
| `model_load_time_ms` | 0 | âŒ No (0/5) |
| `stt_inference_time_ms` | 20 | âœ… Yes |
| `app_idle_ram_mb` | 3 | âŒ No (3/5) |
| `ram_during_transcription_mb` | 1 | âŒ No (1/5) |
| `ram_after_transcription_mb` | 0 | âŒ No (0/5) |
| `wer_percent` | 0 | âŒ No (0/5) |
| `cer_percent` | 0 | âŒ No (0/5) |
| `first_successful_dictation_time_ms` | 0 | âŒ No (0/5) |
| `activation_success_rate` | 0 | âŒ No (0/5) |
...
*Total dictation latency (trigger â†’ paste)*
...
- p95          : 2400.0 ms
- Recent observations:
  - 2026-04-24T20:31 [windows_ryzen7_rtx4060]: 1081.0 ms â€” from_log:2026-04-24T18:48:40 recording-stop-to-paste. steps: cfa=255ms cleanup=150ms paste=644ms
  - 2026-04-24T20:31 [windows_ryzen7_rtx4060]: 2169.0 ms â€” from_log:2026-04-24T18:49:08 recording-stop-to-paste. steps: cfa=886ms cleanup=0ms paste=647ms
  - 2026-04-24T20:31 [windows_ryzen7_rtx4060]: 998.0 ms â€” from_log:2026-04-24T18:49:16 recording-stop-to-paste. steps: cfa=321ms cleanup=0ms paste=645ms
...
- p95          : 886.0 ms
- Recent observations:
  - 2026-04-24T20:33 [windows_ryzen7_rtx4060]: 232.0 ms â€” per_chunk_inference from_log:2026-04-24 Transcription-completed-in line. True single-chunk Parakeet inference.
  - 2026-04-24T20:33 [windows_ryzen7_rtx4060]: 253.0 ms â€” per_chunk_inference from_log:2026-04-24 Transcription-completed-in line. True single-chunk Parakeet inference.
  - 2026-04-24T20:33 [windows_ryzen7_rtx4060]: 303.0 ms â€” per_chunk_inference from_log:2026-04-24 Transcription-completed-in line. True single-chunk Parakeet inference.
...
- p95          : 809.0 mb
- Recent observations:
  - 2026-04-24T21:04 [windows_ryzen7_rtx4060]: 698.0 mb â€” idle, no dictation, app open and ready, measured from Windows Task Manager Working Set
  - 2026-04-24T21:18 [windows_ryzen7_rtx4060]: 699.0 mb â€” idle initial reading before observed memory growth, no intentional dictation
  - 2026-04-24T21:18 [windows_ryzen7_rtx4060]: 809.0 mb â€” idle after ~15 minutes with no intentional dictation â€” RAM grew 110mb unprompted
...
- p95          : 698.0 mb
- Recent observations:
  - 2026-04-24T21:13 [windows_ryzen7_rtx4060]: 698.0 mb â€” peak during short dictation, no visible RAM increase vs idle (698mb), measured from Windows Task Manager Working Set

### Additional metrics recorded

- `capture_duration_ms`: 3 obs, mean 4370.67 ms, range [1831.0â€“7410.0]
- `paste_latency_ms`: 5 obs, mean 652.8 ms, range [644.0â€“687.0]
- `memory_growth_mb`: 1 obs, mean 110.0 mb, range [110.0â€“110.0]
- `idle_background_inference_loop`: 1 obs, mean 1.0 count, range [1.0â€“1.0]
